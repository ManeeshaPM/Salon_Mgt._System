  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29">© Salon Elegant </p>
  
        <div class="col-lg-4 main-social-footer-29">
          <a href="https://www.facebook.com/nelumlankaes" class="facebook"><span class="fa fa-facebook"></span></a>
          <a href="https://www.youtube.com/channel/UCNNLEM0BHZDyZRsn542XDRQ" class="twitter"><span class="fa fa-twitter"></span></a>
