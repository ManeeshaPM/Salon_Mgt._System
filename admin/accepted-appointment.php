...
<html>
<head>
<title>Salon Elegant | Accepted Appointment</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered"> <thead> <tr> <th>No</th> <th> Appointment Number</th> <th>Name</th><th>Mobile Number</th> <th>Date</th><th>Time</th>
							<th>Status</th><th>View / Delete</th> </tr> </thead> <tbody>
<?php
...
?>
                     ...
                     <?php } else { ?>
                      <td><?php  echo $row['Status'];?></td><?php } ?> 
                                         <td><a href="view-appointment.php?viewid=<?php echo $row['bid'];?>" class="btn btn-success">View</a>
