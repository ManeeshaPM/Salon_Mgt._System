...
<html>
<head>
<title> Salon Elegant | Admin Login </title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							...
							<input class=" text-color btn btn-primary" type="submit" name="login" value="Sign In">
							<div class="forgot-grid">
								
								<div class="forgot">
									<a class="forgot text-color btn btn-danger" href="../index.php">Back to Home</a>
								</div>
							...
							<div class="forgot-grid">
								...
								<div class="text-color">
									<a class=" style="color: blue;" href="forgot-password.php">forgot password?</a>
								</div>
								<div class="clearfix"> </div>
							</div>
						</form>
